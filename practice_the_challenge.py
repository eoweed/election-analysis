...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        county_percentage = float(number_of_county_votes) / float(total_votes) * 100

         # 6d: Print the county results to the terminal.
        county_results = (
            f"{county_name}: {county_percentage:.1f}% ({number_of_county_votes:,}\n)"
        )
        ...
        if (number_of_county_votes > largest_county_count) and (county_percentage > largest_county_percentage):
    ...
    winning_county_summary = (
        ...
        f"County Vote Percentage: {largest_county_percentage:.1f}%\n"
        f"----------------\n"
    )
